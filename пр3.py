...
class Shaurma:
    def __init__(self, lavash, meat, ketchup, mayonez, onion, cucumber, tomato, jalapeno, koreancarrot):
        self.lavash = lavash 
        self.meat = meat 
        self.ketchup = ketchup 
        self.mayonez = mayonez 
        self.onion = onion 
        self.cucumber = cucumber 
        self.tomato = tomato 
        self.jalapeno = jalapeno 
        self.koreancarrot = koreancarrot 
    
    def __str__(self):
        return f"Shaurma with {self.jalapeno}, {self.koreancarrot}, {self.ketchup}, {self.mayonez}, {self.onion}, {self.cucumber}, and {self.tomato}"

def check_login(username, password):
    mydb = mysql.connector.connect(host="localhost", database="ShauRai", user="root", password="1234" )
    cursor = mydb.cursor()
...
role = False
#TODO Для входы 
print("Добро пожаловать в 'ШауРай'\n")
print("1. Авторизация\n"
      "2. Регистрация\n")
polz = 0
command = input()
